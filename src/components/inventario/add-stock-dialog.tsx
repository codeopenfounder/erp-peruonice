...
import { addStockSchema, type AddStockSchemaType } from "@/lib/validators/product";
import { useAddProductStock } from "@/hooks/queries/use-products";
...
export function AddStockDialog({
  ...
  const onSubmit = async (data: AddStockSchemaType) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Anadir stock</DialogTitle>
          <DialogDescription>
            Agrega unidades a &quot;{productName}&quot;. Se registrara
