...
export const createCapacityGroupSchema = z.object({
  ...
  shared_capacity: z.coerce.number().int().min(1, "Mínimo 1").max(99999, "Máximo 99999"),
...
export const updateCapacityGroupSchema = z.object({
  ...
  shared_capacity: z.coerce.number().int().min(1, "Mínimo 1").max(99999, "Máximo 99999").optional(),
